...
<div id="user_login">
    <dl>
        ...
        <dd id="user_main">
            <form action="/Booking/index.php/Back/Admin/login.html" method="post">
                <ul>
                    <li class="user_main_l"></li>
                    <li class="user_main_c">
                        <div class="user_main_box">
                            <ul>
                                <li class="user_main_text">管理员名：</li>
                    ...
                    <li class="user_main_r">
                        <input style="border: medium none; background: url('<?php echo (C("BACK_IMG_URL")); ?>user_botton.gif')
                        repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;"
                               value="" type="submit">
                    </li>
                </ul>
            </form>
